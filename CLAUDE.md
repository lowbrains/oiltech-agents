...
2. «Поставить в очередь» не смотрит на флажок: оценка кандидатов уходит в `external-ai` с
   offline=False (`background_jobs.py:371-391`) — с воркером агентов на NL начнёт тратить деньги.
